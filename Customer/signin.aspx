<%@ Page Language="C#" MasterPageFile="~/Customer/Customermaster.master" AutoEventWireup="true" CodeFile="signin.aspx.cs" Inherits="Customer_signin" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 124%; height: 42px;">
        <tr>
            <td class="style30">
            </td>
            <td class="style20">
