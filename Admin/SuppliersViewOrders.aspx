<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SuppliersViewOrders.aspx.cs" Inherits="Admin_SuppliersViewOrders" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" class="style9" valign="top">
                ...
                <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="Load" 
                    BorderColor="Lime" BorderStyle="Ridge" style="height: 26px" />
                <br />
                <br />
